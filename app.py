...
class wm_seg:
    ...
    def __init__(self, master, container):
        ...
        self.master = master
        master.title("Multi-Label Image Segmentation, UCL 2020")
        ...
        self.param_label1_tag = StringVar()
        self.param_label2_tag = StringVar()
        self.param_label3_tag = StringVar()
        self.param_label4_tag = StringVar()
        self.param_label5_tag = StringVar()
        ...
        # image.show()
        print("##################################################")
        print('\x1b[6;30;45m' + 'Multi-Label Lesion Segmentation           ' + '\x1b[0m')
        ...
        self.lable1TagLbltxt = Entry(self.tr_frame,
                              textvariable=self.param_label1_tag)
        ...
        self.lable2Lbltxt = Entry(self.tr_frame, textvariable=self.param_label2_tag)
        ...
        self.lablel3bltxt = Entry(self.tr_frame,
                              textvariable=self.param_label3_tag)
        ...
        self.lablel4LblTxt = Entry(self.tr_frame,
                              textvariable=self.param_label4_tag)
        ...
        self.lablel5Lbl.grid(row=5, column=2,
                             sticky='E', padx=5, pady=2)
        self.lablel5LblTxt = Entry(self.tr_frame, textvariable=self.param_label5_tag)
    ...
    def load_default_configuration(self):
        ...
        self.param_label1_tag.set(default_config.get('database','l1_tags'))
        self.param_label2_tag.set(default_config.get('database','l2_tags'))
        self.param_label3_tag.set(default_config.get('database','l3_tags'))
        self.param_label4_tag.set(default_config.get('database','l4_tags'))
        self.param_label5_tag.set(default_config.get('database','l5_tags'))
    ...
    def write_user_configuration(self):
        ...
        user_config.set('database', 'l1_tags', self.param_label1_tag.get())
        user_config.set('database', 'l2_tags', self.param_label2_tag.get())
        user_config.set('database', 'l3_tags', self.param_label3_tag.get())
        user_config.set('database', 'l4_tags', self.param_label4_tag.get())
        user_config.set('database', 'l5_tags', self.param_label5_tag.get())
